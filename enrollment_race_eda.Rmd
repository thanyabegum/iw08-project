...
enr_1921_change <- enr_1921 %>% mutate(
    ...
    "Pre-K" = percent_change(`Pre-K Halfday.x` + `Pre-K FullDay.x`, `Pre-K Halfday.y` + `Pre-K FullDay.y`),
    "Kindergarten" = percent_change(`Kindergarten Halfday.x` + `Kindergarten Fullday.x`, `Kindergarten Halfday.y` + `Kindergarten Fullday.y`),
...
enr_1921_change <- enr_1921_change %>% select(
    ...
    `%Reduced Lunch`, `Pre-K`, `Kindergarten`, `First Grade`, `Second Grade`,
...
find_total <- function(data) {
    ...
    data <- data %>%
        mutate("Pre-K" = `Pre-K Halfday` + `Pre-K FullDay`, 
               "Kindergarten" = `Kindergarten Halfday` + `Kindergarten Fullday`) %>% 
        select(-`Pre-K Halfday`,-`Pre-K FullDay`, -`Kindergarten Halfday`, 
               -`Kindergarten Fullday`)
    
    data <- data %>% relocate(`Pre-K`, Kindergarten, .before = `First Grade`)
...
enr_1921_change_charter_longer <- enr_1921_change_charter %>% 
    ...
    pivot_longer(cols = everything(), names_to = "Grade",
...
# Rename levels
enr_1921_change_charter_longer$Grade <- c("1st", "2nd", "3rd", "4th", "5th",
                                          "6th", "7th", "8th", "9th", "10th",
                                          "11th", "12th", "Pre-K", "K")
enr_1921_change_public_longer$Grade <- c("1st", "2nd", "3rd", "4th", "5th",
                                          "6th", "7th", "8th", "9th", "10th",
                                          "11th", "12th", "Pre-K", "K")

# Reorder levels
enr_1921_change_charter_longer$Grade <- ordered(enr_1921_change_charter_longer$Grade, 
                                                levels = c("Pre-K", "K", "1st", "2nd",
                                                           "3rd", "4th", "5th", "6th",
                                                           "7th", "8th", "9th", "10th",
                                                           "11th", "12th"))
enr_1921_change_public_longer$Grade <- ordered(enr_1921_change_public_longer$Grade, 
                                                levels = c("Pre-K", "K", "1st", "2nd",
                                                           "3rd", "4th", "5th", "6th",
                                                           "7th", "8th", "9th", "10th",
                                                           "11th", "12th"))
...
enr_1921_change_both_longer %>%
    ...
    labs(title = "NJ Enrollment Change by Grade and School Type") +
